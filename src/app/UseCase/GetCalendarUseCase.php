...
class GetCalendarUseCase extends ApiUseCase implements GetCalendarInterface
{
    ...
    private function getLastDayOfPage(\DateTimeImmutable $lastDayOfMonth, int $startWeekday) : \DateTimeImmutable
    {
        ...
        // 00:00:00の日付同士だと最後の一日がカウントされないので時間を足しておく
        return $lastDayOfMonth->modify("+${diff} days noon");
    }
    /**
     * カレンダーページを取得する
     * @return datePeriod
